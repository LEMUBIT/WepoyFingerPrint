...
class AttendanceRecyclerViewAdapter internal constructor(data: RealmResults<AttendanceRealmModel>, val context: Context) : RealmRecyclerViewAdapter<AttendanceRealmModel, AttendanceRecyclerViewAdapter.MyViewHolder>(data, true) {
